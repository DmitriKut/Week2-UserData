...
namespace DvingLisence
{
	class Program
	{
		static void Main(string[] args)
		{
			//programm küsib kasutaja sünniaaastat
			//programm arvutab kasutaja vanust
			//kui kasutaja on noorem, kui 18, siis programm kuvab konsolis
			...
			//"Palju õnne! Nüüd sa saad juhelube taotleda";
			...
			{
				Console.WriteLine("Palju õnne! Nüüd sa saad juhelube taotleda");
			}
